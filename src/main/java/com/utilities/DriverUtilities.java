...
public class DriverUtilities {
	...
	public static boolean openUrl(WebDriver driver, String url) {
		Report.info("Entering DriverUtilities::openUrl()");
		...
		Report.info("Exiting DriverUtilities::openUrl() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static boolean clickOnElement(WebElement element) {
		Report.info("Entering DriverUtilities::clickOnElement()");
		boolean isSuccess = false;
		try {
			element.click();
			isSuccess = true;
		...
		Report.info("Exiting DriverUtilities::clickOnElement() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	{
		Report.info("Entering DriverUtilities::SwitchToFrame()");
		boolean isSuccess = false;
		try {
		...
		Report.info("Exiting DriverUtilities::SwitchToFrame() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static String enterText(WebElement element, String text) {
		Report.info("Entering DriverUtilities::enterText()");
		String enteredText = "";
		try {
		...
		Report.info("Exiting DriverUtilities::enterText() with '" + enteredText + '"');
		return enteredText;
	}
	...
	public static boolean selectDropdown(WebElement element, String dropdownValue) {
		Report.info("Entering DriverUtilities::selectDropdown()");
		boolean isSuccess = false;
		try {
		...
		Report.info("Exiting DriverUtilities::selectDropdown() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static boolean deleteCookies(WebDriver driver) {
		Report.info("Entering DriverUtilities::deleteCookies()");
		boolean isSuccess = false;
		try {
		...
		Report.info("Exiting DriverUtilities::deleteCookies() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static boolean closeBrowser(WebDriver driver) {
		Report.info("Entering DriverUtilities::closeBrowser()");
		boolean isSuccess = false;
		try {
			driver.close();
			isSuccess = true;
		...
		Report.info("Exiting DriverUtilities::closeBrowser() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static boolean quitDriver(WebDriver driver) {
		Report.info("Entering DriverUtilities::quitDriver()");
		boolean isSuccess = false;
		try {
			driver.quit();
			isSuccess = true;
		...
		Report.info("Exiting DriverUtilities::quitDriver() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static String getText(WebElement element) {
		Report.info("Entering DriverUtilities::getText()");
		String text = "";
		try {
		...
		Report.info("Exiting DriverUtilities::getText() with '" + text + '"');
		return text;
	}
	...
	public static boolean waitForElementToBecomeVisible(WebDriver driver, WebElement element, int seconds) {
		Report.info("Entering DriverUtilities::waitForElementToBecomeVisible()");
		boolean isSuccess = false;
		try {
		...
		Report.info("Exiting DriverUtilities::waitForElementToBecomeVisible() with '" + isSuccess + '"');
		return isSuccess;
	}
	...
	public static void takeScreenshot(WebDriver driver, String filePath) {
		Report.info("Entering DriverUtilities::takeScreenshot() with '" + filePath + '"');
		try {
		...
		Report.info("Exiting DriverUtilities::takeScreenshot()");
	}
	...
	public static List<WebElement> getAllWebElements(WebDriver driver, By element) {
		Report.info("Entering DriverUtilities::getAllWebElements()");
		...
		Report.info("Exiting DriverUtilities::getAllWebElements() with size " + elementList.size());
		return elementList;
	}
}
